...
import uc.seng301.wordleapp.lab4.accessor.GameRecordAccessor;
import uc.seng301.wordleapp.lab4.accessor.UserAccessor;
...
public class CreateNewGameRecordFeature {
    ...
    public void i_have_a_player(String name) {
        ...
        Assertions.assertNotNull(player.getUserId(), name);
    }
